...
async function main() {
  ...
  await tryEndpoint('mp-search-api v2', 'https://mp-search-api.tcgplayer.com/v2/search/request?q=&isList=false', {
    from: 0,
    size: 3,
    filters: {
      term: { productId: [productId] },
  ...
  await tryEndpoint(
    'mp-search-api with product name search',
  ...
  await tryEndpoint(
    'mp-search-api with default algorithm',
    'https://mp-search-api.tcgplayer.com/v1/search/request?q=&isList=false',
    {
